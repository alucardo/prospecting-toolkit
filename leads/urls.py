...
urlpatterns = [
    ...
    path('leads/<int:pk>/geocode/', views.lead.lead_geocode, name='lead_geocode'),
    path('leads/<int:pk>/geocode/manual/', views.lead.lead_geocode_manual, name='lead_geocode_manual'),
    ...
    path('settings/check-email/', views.settings_module.check_unread_emails, name='check_unread_emails'),
    ...
    path('frazy/<int:pk>/debug/', views.voivodeship_keywords.voivodeship_keyword_debug, name='voivodeship_keyword_debug'),
    ...
    path('zadania/add/', views.lead_task.task_add_ajax, name='task_add_ajax'),
    ...
    # Pomysły na posty
    path('pomysly-na-posty/', views.post_ideas.idea_index, name='idea_index'),
